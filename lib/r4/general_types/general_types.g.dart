...
_Attachment _$AttachmentFromJson(Map<String, dynamic> json) => _Attachment(
  ...
  size: json['size'] == null ? null : FhirUnsignedInt.fromJson(json['size']),
...
_TimingRepeat _$TimingRepeatFromJson(
  ...
  durationUnit: $enumDecodeNullable(
    _$TimingRepeatDurationUnitEnumMap,
    json['durationUnit'],
  ...
  periodUnit: $enumDecodeNullable(
    _$TimingRepeatPeriodUnitEnumMap,
    json['periodUnit'],
