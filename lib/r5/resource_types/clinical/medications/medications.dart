...
///  itself.
@freezed
abstract class FormularyItem with Resource, _$FormularyItem {
  /// [FormularyItem] This resource describes a product or service that is
  ///  available through a program and includes the conditions and constraints of
  ///  availability.  All of the information in this resource is specific to the
  ///  inclusion of the item in the formulary and is not inherent to the item
...
@freezed
abstract class ImmunizationProgramEligibility
  ...
  /// Factory constructor that accepts a [String] in YAML format as an argument
  factory ImmunizationProgramEligibility.fromYaml(dynamic yaml) =>
      yaml is String
...
@freezed
abstract class MedicationKnowledgeIndicationGuideline
  ...
  /// Factory constructor that accepts a [String] in YAML format as an argument
  factory MedicationKnowledgeIndicationGuideline.fromYaml(dynamic yaml) =>
      yaml is String
...
@freezed
abstract class MedicationKnowledgeDosingGuideline
  ...
  /// Factory constructor that accepts a [String] in YAML format as an argument
  factory MedicationKnowledgeDosingGuideline.fromYaml(dynamic yaml) =>
      yaml is String
...
///  is used to support knowledge.
@freezed
abstract class MedicationKnowledgeStorageGuideline
  ...
  /// Factory constructor that accepts a [String] in YAML format as an argument
  factory MedicationKnowledgeStorageGuideline.fromYaml(dynamic yaml) =>
      yaml is String
...
///  that is used to support knowledge.
@freezed
abstract class MedicationKnowledgeEnvironmentalSetting
  ...
  /// Factory constructor that accepts a [String] in YAML format as an argument
  factory MedicationKnowledgeEnvironmentalSetting.fromYaml(dynamic yaml) =>
      yaml is String
...
///  used to support knowledge.
@freezed
abstract class MedicationKnowledgeDefinitional
  ...
  /// Factory constructor that accepts a [String] in YAML format as an argument
  factory MedicationKnowledgeDefinitional.fromYaml(dynamic yaml) =>
      yaml is String
...
@freezed
abstract class MedicationStatementAdherence
