...
_ElementDefinition _$ElementDefinitionFromJson(
  ...
  defaultValueExtendedContactDetail:
      ...
      : ExtendedContactDetail.fromJson(
          json['defaultValueExtendedContactDetail'] as Map<String, dynamic>,
        ),
  ...
  fixedOid: json['fixedOid'] == null ? null : FhirId.fromJson(json['fixedOid']),
  ...
  fixedUuid: json['fixedUuid'] == null
      ? null
      : FhirId.fromJson(json['fixedUuid']),
...
Map<String, dynamic> _$ElementDefinitionToJson(
  ...
  '_defaultValueInteger64': ?instance.defaultValueInteger64Element?.toJson(),
  ...
  'defaultValueExtendedContactDetail': ?instance
      .defaultValueExtendedContactDetail
      ?.toJson(),
  ...
  'fixedInteger64': ?instance.fixedInteger64?.toJson(),
  '_fixedInteger64': ?instance.fixedInteger64Element?.toJson(),
  ...
  'fixedAvailability': ?instance.fixedAvailability?.toJson(),
  'fixedExtendedContactDetail': ?instance.fixedExtendedContactDetail?.toJson(),
  ...
  'patternInteger64': ?instance.patternInteger64?.toJson(),
  '_patternInteger64': ?instance.patternInteger64Element?.toJson(),
  ...
  'patternAvailability': ?instance.patternAvailability?.toJson(),
  ...
  'minValueInteger64': ?instance.minValueInteger64?.toJson(),
  ...
  'maxValueInteger64': ?instance.maxValueInteger64?.toJson(),
  ...
  'mustHaveValue': ?instance.mustHaveValue?.toJson(),
  '_mustHaveValue': ?instance.mustHaveValueElement?.toJson(),
...
_ElementDefinitionType _$ElementDefinitionTypeFromJson(
  ...
  aggregation: $enumDecodeNullable(
    _$ElementDefinitionTypeAggregationEnumMap,
    json['aggregation'],
  ),
...
Map<String, dynamic> _$ElementDefinitionTypeToJson(
  ...
  '_aggregation': ?instance.aggregationElement?.map((e) => e.toJson()).toList(),
...
Map<String, dynamic> _$ElementDefinitionConstraintToJson(
  ...
  'suppress': ?instance.suppress?.toJson(),
  '_suppress': ?instance.suppressElement?.toJson(),
...
_ElementDefinitionBinding _$ElementDefinitionBindingFromJson(
  ...
  additional: (json['additional'] as List<dynamic>?)
      ?.map(
        (e) => ElementDefinitionAdditional.fromJson(e as Map<String, dynamic>),
      )
      .toList(),
);
...
_ElementDefinitionAdditional _$ElementDefinitionAdditionalFromJson(
  Map<String, dynamic> json,
...
Map<String, dynamic> _$ElementDefinitionAdditionalToJson(
  _ElementDefinitionAdditional instance,
) => <String, dynamic>{
  'id': ?instance.id,
  'extension': ?instance.extension_?.map((e) => e.toJson()).toList(),
  'modifierExtension': ?instance.modifierExtension
  ...
  '_shortDoco': ?instance.shortDocoElement?.toJson(),
  'usage': ?instance.usage?.map((e) => e.toJson()).toList(),
  'any': ?instance.any?.toJson(),
  '_any': ?instance.anyElement?.toJson(),
};
