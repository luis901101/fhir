...
Map<String, dynamic> _$AnnotationToJson(_Annotation instance) =>
    <String, dynamic>{
      ...
      '_authorString': ?instance.authorStringElement?.toJson(),
...
_Attachment _$AttachmentFromJson(Map<String, dynamic> json) => _Attachment(
  ...
  hash: json['hash'] == null ? null : FhirBase64Binary.fromJson(json['hash']),
  ...
  pages: json['pages'] == null ? null : FhirPositiveInt.fromJson(json['pages']),
...
Map<String, dynamic> _$AttachmentToJson(_Attachment instance) =>
    <String, dynamic>{
      ...
      '_size': ?instance.sizeElement?.toJson(),
      'hash': ?instance.hash?.toJson(),
      '_hash': ?instance.hashElement?.toJson(),
      ...
      '_pages': ?instance.pagesElement?.toJson(),
    };
...
_CodeableConcept _$CodeableConceptFromJson(Map<String, dynamic> json) =>
    _CodeableConcept(
      id: json['id'] as String?,
      extension_: (json['extension'] as List<dynamic>?)
          ?.map((e) => FhirExtension.fromJson(e as Map<String, dynamic>))
...
Map<String, dynamic> _$CodeableConceptToJson(_CodeableConcept instance) =>
    <String, dynamic>{
      'id': ?instance.id,
      'extension': ?instance.extension_?.map((e) => e.toJson()).toList(),
...
_Coding _$CodingFromJson(Map<String, dynamic> json) => _Coding(
  id: json['id'] as String?,
  extension_: (json['extension'] as List<dynamic>?)
      ?.map((e) => FhirExtension.fromJson(e as Map<String, dynamic>))
      .toList(),
...
Map<String, dynamic> _$CodingToJson(_Coding instance) => <String, dynamic>{
  'id': ?instance.id,
  'extension': ?instance.extension_?.map((e) => e.toJson()).toList(),
  'system': ?instance.system?.toJson(),
  '_system': ?instance.systemElement?.toJson(),
  ...
  'userSelected': ?instance.userSelected?.toJson(),
  '_userSelected': ?instance.userSelectedElement?.toJson(),
};
...
_FhirDuration _$FhirDurationFromJson(Map<String, dynamic> json) =>
    _FhirDuration(
      id: json['id'] as String?,
      extension_: (json['extension'] as List<dynamic>?)
          ?.map((e) => FhirExtension.fromJson(e as Map<String, dynamic>))
...
Map<String, dynamic> _$FhirDurationToJson(_FhirDuration instance) =>
    <String, dynamic>{
      'id': ?instance.id,
      'extension': ?instance.extension_?.map((e) => e.toJson()).toList(),
      'value': ?instance.value?.toJson(),
...
_Count _$CountFromJson(Map<String, dynamic> json) => _Count(
  ...
  valueElement: json['_value'] == null
      ? null
      : Element.fromJson(json['_value'] as Map<String, dynamic>),
  comparator: $enumDecodeNullable(_$CountComparatorEnumMap, json['comparator']),
  comparatorElement: json['_comparator'] == null
      ? null
      : Element.fromJson(json['_comparator'] as Map<String, dynamic>),
  unit: json['unit'] as String?,
...
_Money _$MoneyFromJson(Map<String, dynamic> json) => _Money(
  ...
  currency: json['currency'] == null
      ? null
      : FhirCode.fromJson(json['currency']),
...
Map<String, dynamic> _$MoneyToJson(_Money instance) => <String, dynamic>{
  ...
  '_currency': ?instance.currencyElement?.toJson(),
};
...
_Age _$AgeFromJson(Map<String, dynamic> json) => _Age(
  ...
  valueElement: json['_value'] == null
      ? null
      : Element.fromJson(json['_value'] as Map<String, dynamic>),
  comparator: $enumDecodeNullable(_$AgeComparatorEnumMap, json['comparator']),
  comparatorElement: json['_comparator'] == null
      ? null
      : Element.fromJson(json['_comparator'] as Map<String, dynamic>),
  unit: json['unit'] as String?,
...
_Ratio _$RatioFromJson(Map<String, dynamic> json) => _Ratio(
  id: json['id'] as String?,
  extension_: (json['extension'] as List<dynamic>?)
      ?.map((e) => FhirExtension.fromJson(e as Map<String, dynamic>))
      .toList(),
...
Map<String, dynamic> _$RatioToJson(_Ratio instance) => <String, dynamic>{
  'id': ?instance.id,
  'extension': ?instance.extension_?.map((e) => e.toJson()).toList(),
...
_RatioRange _$RatioRangeFromJson(Map<String, dynamic> json) => _RatioRange(
  id: json['id'] as String?,
  extension_: (json['extension'] as List<dynamic>?)
      ?.map((e) => FhirExtension.fromJson(e as Map<String, dynamic>))
      .toList(),
...
Map<String, dynamic> _$RatioRangeToJson(_RatioRange instance) =>
    <String, dynamic>{
      'id': ?instance.id,
      'extension': ?instance.extension_?.map((e) => e.toJson()).toList(),
      'lowNumerator': ?instance.lowNumerator?.toJson(),
      'highNumerator': ?instance.highNumerator?.toJson(),
      'denominator': ?instance.denominator?.toJson(),
    };

_SampledData _$SampledDataFromJson(Map<String, dynamic> json) => _SampledData(
  id: json['id'] as String?,
  extension_: (json['extension'] as List<dynamic>?)
      ?.map((e) => FhirExtension.fromJson(e as Map<String, dynamic>))
      .toList(),
...
Map<String, dynamic> _$SampledDataToJson(_SampledData instance) =>
    <String, dynamic>{
      'id': ?instance.id,
      'extension': ?instance.extension_?.map((e) => e.toJson()).toList(),
      'origin': instance.origin.toJson(),
      'interval': ?instance.interval?.toJson(),
      '_interval': ?instance.intervalElement?.toJson(),
      'intervalUnit': ?instance.intervalUnit?.toJson(),
      '_intervalUnit': ?instance.intervalUnitElement?.toJson(),
      'factor': ?instance.factor?.toJson(),
      '_factor': ?instance.factorElement?.toJson(),
      'lowerLimit': ?instance.lowerLimit?.toJson(),
      '_lowerLimit': ?instance.lowerLimitElement?.toJson(),
      'upperLimit': ?instance.upperLimit?.toJson(),
      '_upperLimit': ?instance.upperLimitElement?.toJson(),
      'dimensions': ?instance.dimensions?.toJson(),
      '_dimensions': ?instance.dimensionsElement?.toJson(),
      'codeMap': ?instance.codeMap?.toJson(),
      'offsets': ?instance.offsets,
      '_offsets': ?instance.offsetsElement?.toJson(),
      'data': ?instance.data,
      '_data': ?instance.dataElement?.toJson(),
    };
...
Map<String, dynamic> _$SignatureToJson(_Signature instance) =>
    <String, dynamic>{
      ...
      '_when': ?instance.whenElement?.toJson(),
      'who': ?instance.who?.toJson(),
      'onBehalfOf': ?instance.onBehalfOf?.toJson(),
      'targetFormat': ?instance.targetFormat?.toJson(),
      '_targetFormat': ?instance.targetFormatElement?.toJson(),
      'sigFormat': ?instance.sigFormat?.toJson(),
      '_sigFormat': ?instance.sigFormatElement?.toJson(),
      'data': ?instance.data?.toJson(),
      '_data': ?instance.dataElement?.toJson(),
    };

_HumanName _$HumanNameFromJson(Map<String, dynamic> json) => _HumanName(
  id: json['id'] as String?,
  extension_: (json['extension'] as List<dynamic>?)
      ?.map((e) => FhirExtension.fromJson(e as Map<String, dynamic>))
      .toList(),
...
Map<String, dynamic> _$HumanNameToJson(_HumanName instance) =>
    <String, dynamic>{
      'id': ?instance.id,
      'extension': ?instance.extension_?.map((e) => e.toJson()).toList(),
      ...
      '_family': ?instance.familyElement?.toJson(),
...
Map<String, dynamic> _$AddressToJson(_Address instance) => <String, dynamic>{
  ...
  'city': ?instance.city,
  '_city': ?instance.cityElement?.toJson(),
  'district': ?instance.district,
  '_district': ?instance.districtElement?.toJson(),
  'state': ?instance.state,
  '_state': ?instance.stateElement?.toJson(),
  'postalCode': ?instance.postalCode,
  '_postalCode': ?instance.postalCodeElement?.toJson(),
  'country': ?instance.country,
  '_country': ?instance.countryElement?.toJson(),
  'period': ?instance.period?.toJson(),
};
...
_ContactPoint _$ContactPointFromJson(Map<String, dynamic> json) =>
    _ContactPoint(
      id: json['id'] as String?,
      extension_: (json['extension'] as List<dynamic>?)
          ?.map((e) => FhirExtension.fromJson(e as Map<String, dynamic>))
...
Map<String, dynamic> _$ContactPointToJson(_ContactPoint instance) =>
    <String, dynamic>{
      'id': ?instance.id,
      'extension': ?instance.extension_?.map((e) => e.toJson()).toList(),
...
_Timing _$TimingFromJson(Map<String, dynamic> json) => _Timing(
  id: json['id'] as String?,
  extension_: (json['extension'] as List<dynamic>?)
      ?.map((e) => FhirExtension.fromJson(e as Map<String, dynamic>))
      .toList(),
...
Map<String, dynamic> _$TimingToJson(_Timing instance) => <String, dynamic>{
  'id': ?instance.id,
  'extension': ?instance.extension_?.map((e) => e.toJson()).toList(),
...
_TimingRepeat _$TimingRepeatFromJson(
  ...
  count: json['count'] == null ? null : FhirPositiveInt.fromJson(json['count']),
  ...
  durationUnit: $enumDecodeNullable(_$UnitsOfTimeEnumMap, json['durationUnit']),
  ...
  period: json['period'] == null ? null : FhirDecimal.fromJson(json['period']),
...
Map<String, dynamic> _$TimingRepeatToJson(
  _TimingRepeat instance,
) => <String, dynamic>{
  'id': ?instance.id,
  'extension': ?instance.extension_?.map((e) => e.toJson()).toList(),
  'modifierExtension': ?instance.modifierExtension
  ...
  'countMax': ?instance.countMax?.toJson(),
  '_countMax': ?instance.countMaxElement?.toJson(),
  'duration': ?instance.duration?.toJson(),
  '_duration': ?instance.durationElement?.toJson(),
  'durationMax': ?instance.durationMax?.toJson(),
  '_durationMax': ?instance.durationMaxElement?.toJson(),
  'durationUnit': ?_$UnitsOfTimeEnumMap[instance.durationUnit],
  '_durationUnit': ?instance.durationUnitElement?.toJson(),
  'frequency': ?instance.frequency?.toJson(),
  '_frequency': ?instance.frequencyElement?.toJson(),
  'frequencyMax': ?instance.frequencyMax?.toJson(),
  '_frequencyMax': ?instance.frequencyMaxElement?.toJson(),
  'period': ?instance.period?.toJson(),
  '_period': ?instance.periodElement?.toJson(),
  'periodMax': ?instance.periodMax?.toJson(),
  '_periodMax': ?instance.periodMaxElement?.toJson(),
  'periodUnit': ?_$UnitsOfTimeEnumMap[instance.periodUnit],
  '_periodUnit': ?instance.periodUnitElement?.toJson(),
  'dayOfWeek': ?instance.dayOfWeek
      ?.map((e) => _$DaysOfWeekEnumMap[e]!)
      .toList(),
