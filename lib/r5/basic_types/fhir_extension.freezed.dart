...
@JsonKey(name: 'extension') List<FhirExtension>? get extension_;/// [url] Source of the definition for the extension code - a logical name
///  or
///  a URL.
 FhirUri? get url;/// [urlElement] Extensions for url
@JsonKey(name: '_url') Element? get urlElement;/// [valueBase64Binary] Value of extension - must be one of a constrained
///  set
...
@JsonKey(name: '_valueBoolean') Element? get valueBooleanElement;/// [valueCanonical] Value of extension - must be one of a constrained set
///  of
///  the data types (see [Extensibility](extensibility.html) for a list).
...
///  the data types (see [Extensibility](extensibility.html) for a list).
 FhirInteger64? get valueInteger64;/// [valueMarkdownElement] Extensions for valueMarkdown
@JsonKey(name: '_valueInteger64') Element? get valueInteger64Element; FhirMarkdown? get valueMarkdown;@JsonKey(name: '_valueMarkdown') Element? get valueMarkdownElement;/// [valueOid] Value of extension - must be one of a constrained set of the
///  data types (see [Extensibility](extensibility.html) for a list).
...
///  of the data types (see [Extensibility](extensibility.html) for a list).
 Attachment? get valueAttachment;/// [valueAvailability] Value of extension - must be one of a constrained
///  set
///  of the data types (see [Extensibility](extensibility.html) for a list).
 Availability? get valueAvailability;/// [valueCodeableConcept] Value of extension - must be one of a constrained
/// set of the data types (see [Extensibility](extensibility.html) for a
///  list).
 CodeableConcept? get valueCodeableConcept;/// [valueCodeableReference] A reference to a resource (by instance), or
...
///  the data types (see [Extensibility](extensibility.html) for a list).
 Coding? get valueCoding;/// [valueContactPoint] Value of extension - must be one of a constrained
///  set
///  of the data types (see [Extensibility](extensibility.html) for a list).
 ContactPoint? get valueContactPoint;/// [valueCount] Value of extension - must be one of a constrained set of
///  the
///  data types (see [Extensibility](extensibility.html) for a list).
...
///  the data types (see [Extensibility](extensibility.html) for a list).
 FhirDuration? get valueDuration;/// [valueHumanName] Value of extension - must be one of a constrained set
///  of
///  the data types (see [Extensibility](extensibility.html) for a list).
 HumanName? get valueHumanName;/// [valueIdentifier] Value of extension - must be one of a constrained set
///  of the data types (see [Extensibility](extensibility.html) for a list).
 Identifier? get valueIdentifier;/// [valueMoney] Value of extension - must be one of a constrained set of
///  the
///  data types (see [Extensibility](extensibility.html) for a list).
...
///  the data types (see [Extensibility](extensibility.html) for a list).
 Quantity? get valueQuantity;/// [valueRange] Value of extension - must be one of a constrained set of
///  the
///  data types (see [Extensibility](extensibility.html) for a list).
 Range? get valueRange;/// [valueRatio] Value of extension - must be one of a constrained set of
///  the
///  data types (see [Extensibility](extensibility.html) for a list).
 Ratio? get valueRatio;/// [valueReference] Value of extension - must be one of a constrained set
///  of
///  the data types (see [Extensibility](extensibility.html) for a list).
 Reference? get valueReference;/// [valueSampledData] Value of extension - must be one of a constrained set
///  of the data types (see [Extensibility](extensibility.html) for a list).
 SampledData? get valueSampledData;/// [valueSignature] Value of extension - must be one of a constrained set
///  of
///  the data types (see [Extensibility](extensibility.html) for a list).
...
///  [Extensibility](extensibility.html)
///  for a list).
 TriggerDefinition? get valueTriggerDefinition;/// [valueUsageContext] Value of extension - must be one of a constrained
///  set
///  of the data types (see [Extensibility](extensibility.html) for a list).
 UsageContext? get valueUsageContext;/// [valueDosage] Value of extension - must be one of a constrained set of
///  the data types (see [Extensibility](extensibility.html) for a list).
 Dosage? get valueDosage;/// [valueMeta] Value of extension - must be one of a constrained set of the
///  data types (see [Extensibility](extensibility.html) for a list).
...
as Element?,valueInteger64: freezed == valueInteger64 ? _self.valueInteger64 : valueInteger64 // ignore: cast_nullable_to_non_nullable
as FhirInteger64?,valueInteger64Element: freezed == valueInteger64Element ? _self.valueInteger64Element : valueInteger64Element // ignore: cast_nullable_to_non_nullable
...
as Attachment?,valueAvailability: freezed == valueAvailability ? _self.valueAvailability : valueAvailability // ignore: cast_nullable_to_non_nullable
as Availability?,valueCodeableConcept: freezed == valueCodeableConcept ? _self.valueCodeableConcept : valueCodeableConcept // ignore: cast_nullable_to_non_nullable
...
$ElementCopyWith<$Res>? get valueInteger64Element {
    if (_self.valueInteger64Element == null) {
    return null;
  }

  return $ElementCopyWith<$Res>(_self.valueInteger64Element!, (value) {
    return _then(_self.copyWith(valueInteger64Element: value));
  });
}/// Create a copy of FhirExtension
/// with the given fields replaced by the non-null parameter values.
@override
...
$AvailabilityCopyWith<$Res>? get valueAvailability {
    if (_self.valueAvailability == null) {
    return null;
  }

  return $AvailabilityCopyWith<$Res>(_self.valueAvailability!, (value) {
    return _then(_self.copyWith(valueAvailability: value));
  });
}/// Create a copy of FhirExtension
/// with the given fields replaced by the non-null parameter values.
@override
...
///  the data types (see [Extensibility](extensibility.html) for a list).
@override final  FhirInteger64? valueInteger64;
/// [valueMarkdownElement] Extensions for valueMarkdown
@override@JsonKey(name: '_valueInteger64') final  Element? valueInteger64Element;
...
///  set
///  of the data types (see [Extensibility](extensibility.html) for a list).
@override final  Availability? valueAvailability;
